...
<div id="content">
	<div id="wrapper-add-btn">
		<div class="idealWrap">
			...
			<a href="new-customer.php"><input type="button" name="button" value="Add Customer" /></a>
			</form>
		</div>
	</div>
	<div id="wrapper-link">
    ...
    <table cellspacing="0">
		...
		?>
   		<tr>
			...
			<td><a href="edit-customer.php?cus_id=<?php echo $row['cus_id']; ?>">Edit</a></th>	
			<td><a href="delete-customer.php?cus_id=<?php echo $row['cus_id']?>" onclick="return confirm('Are you sure to delete??');">Delete</a></th>
			<td><a href="view-customer.php?cus_id=<?php echo $row['cus_id']; ?>">View</a></th>	
		</tr>
    	<?php }?>
    </table>
